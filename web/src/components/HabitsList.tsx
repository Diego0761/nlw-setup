      ...
      {habitsInfo?.possibleHabits.map(habit => {
        return (
          <Checkbox.Root
            ...
            className="flex items-center gap-3 group focus:outline-non disabled:cursor-not-allowed"
          ...
          >
            ...
            <span className="font-semibold text-xl text-white leading-tight group-data-[state=checked]:line-through group-data-[state=checked]:text-zinc-400 transition">
              {habit.title}
            </span>
          </Checkbox.Root>
        )
